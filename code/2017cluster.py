...
def filter_pca_features(features_pca, range_min=-10, range_max=10):
    """
    Optimized filter for PCA features using vectorized operations
    """
    ...
    filtered_features = features_with_arrays.filter(
...
filtered_features = filter_pca_features(features_pca, -10, 10)
